...
<body>
  ...
  <div class="page-wrapper">
    ...
    <section class="inner-page-hero bg-image" data-image-src="images/img/menubg2.png">
      <div class="profile">
        <div class="container">
          <div class="row">
              ...
              <div class="widget-body">
                ...
                if (!empty($_SESSION["cart_item"])) {
                  foreach ($_SESSION["cart_item"] as $item) {
                    echo '<div class="title-row">'.$item["title"].'
                      <a href="dishes.php?res_id='.$_GET['res_id'].'&action=remove&id='.$item["d_id"].'">
            ...
            <div class="widget-body">
              <div class="price-wrap text-xs-center">
                ...
                <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check" 
                   class="btn btn-<?php echo $item_total == 0 ? 'danger disabled' : 'success active'; ?> btn-lg">
                  Checkout
                </a>
              </div>
            </div>
