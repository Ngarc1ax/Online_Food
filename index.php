...
<head>
    ...
    <style>
        ...
        .bg-img::before {
            ...
            width: 100%;
            height: 100%;
            background: #1e1e1e !important; /* Adjust darkness */
            z-index: 1;
        }
...
<body class="home">
    <header id="header" class="header-scroll top-header headrom">
        ...
        <section class="hero bg-image" data-image-src="images/img/indexbg2.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1 style="color: #ffc524">Order Delivery & Take-Out</h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color: #ffc524;">1. </span>Choose Restaurant</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color: #ffc524;">2. </span>Order Food</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color: #ffc524;">3. </span>Delivery or take out</h4> </div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="popular">
            <div class="container">
                <div class="container my-5">
                    <h2 class="text-center">Popular Dishes of the Month</h2>
                    <p class="text-center text-muted">Easiest way to order your favourite food among these top 3 dishes</p>
        ...
        <section class="how-it-works bg-img">
            <div class="container">
