...
<head>
    ...
    <style>
        .card-outline-primary .card-header {
            ...
            border-color: #1d503a !important;
        }
        .btn-primary:not(.delivered-btn) {
            background-color: #1d503a !important;
            border-color: #1d503a !important;
        }
        .btn-primary:not(.delivered-btn):hover, 
        .btn-primary:not(.delivered-btn):focus, 
        .btn-primary:not(.delivered-btn):active {
            background-color: #14532d !important;
            border-color: #134e2e !important;
        }
    </style>
													...
													<?php 
																		   ...
																		   <?php 
																			...
																			if($status=="closed")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-primary delivered-btn" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Delivered</button></center></td> 
																			<?php 
																			} 
																			?>
																			<?php
